...
void signal_process_message(PurpleConnection *pc, const std::string & chat, const std::string & sender, const char * message, const long timestamp, const PurpleMessageFlags flags);
